  ...
  return (
    <div className="space-y-8">
      <section className="flex items-start justify-between gap-4">
        <div>
          <p className="text-sm font-semibold text-emerald-700">Journeys</p>
          <h1 className="mt-1 text-3xl font-semibold text-stone-950">
            All journeys
          </h1>
          <p className="mt-3 max-w-xl text-base leading-7 text-stone-600">
            Active, upcoming, and completed journeys in one place.
          </p>
        </div>
        <Link
          href="/trips/new"
      ...
      {!isLoading && !error && items.length === 0 ? (
        <section className="rounded-2xl border border-dashed border-stone-300 bg-white p-6 text-center shadow-sm">
          ...
          <p className="mt-2 text-sm leading-6 text-stone-600">
            Create your first group journey to start planning and capturing.
          </p>
          <Link
            href="/trips/new"
