  ...
  return (
    ...
    >
      ...
      <button
        ...
        onClick={onClose}
        aria-label="关闭图片预览"
        className="flex min-h-0 flex-1 items-center justify-center px-2 py-16"
      >
        <img
          src={imageUrl}
          alt={title || "图片预览"}
      ...
      <div className="absolute inset-x-0 bottom-0 z-20 bg-gradient-to-t from-black via-black/88 to-transparent px-3 pb-[calc(1rem+env(safe-area-inset-bottom,0px))] pt-16">
